            ...
            <thead>
              {headerGroups.map((headerGroup) => (
                <tr
                  ...
                  className="text-left border-b border-gray-300 bg-[#F7F8FB] text-[#667085]"
                >
                  {headerGroup.headers.map((column, colIndex) => (
                    <th
                      {...column.getHeaderProps()}
                      className={`py-2 px-4 text-sm md:text-base font-semibold ${colIndex === 0 ? "sticky left-0 z-10 bg-[#F7F8FB]" : ""
                        }`}
                    >
                ...
                return (
                  ...
                  >
                    {row.cells.map((cell, cellIndex) => (
                      <td
                        {...cell.getCellProps()}
                        className={`py-2 px-4 text-sm md:text-base ${cellIndex === 0 ? "sticky left-0 z-10 bg-white" : ""
                          }`}
                      >
                        {cell.render("Cell")}
                      </td>
