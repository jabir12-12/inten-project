...
const BASE_STOCKS = [
    { symbol: 'INFY.NS', category: 'IT', purchasePrice: 1350, quantity: 20 },
    { symbol: 'TCS.NS', category: 'IT', purchasePrice: 3200, quantity: 10 },
    { symbol: 'HCLTECH.NS', category: 'IT', purchasePrice: 1100, quantity: 25 },
        ...
        <div className="flex flex-col gap-4 border border-gray-200 rounded-lg p-4 bg-white shadow-sm max-w-full w-full sm:w-[90vw] md:w-[600px] lg:w-[700px] mx-auto">
            ...
            <ResponsiveContainer width="100%" height={300}>
                ...
                >
                    ...
                    <Bar dataKey="invested" name="Invested" fill="#9012FF" />
                    <Bar dataKey="current" name="Current" fill="#17B26A" />
                </BarChart>
            </ResponsiveContainer>
        </div>
    );
