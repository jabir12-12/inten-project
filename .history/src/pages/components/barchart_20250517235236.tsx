...
export default function BarChartComponent() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const res = await fetch('/api/route'); // Replace with your actual API route URL
        ...
        return (
            ...
            >
                <Spinner
                    ...
                    color="danger"
                    variant="spinner"
                    classNames={{ label: "text-red-500 mt-4" }}
                />
            </div>
        );
    }
        ...
        <div className="flex flex-col gap-5 border border-gray-200 rounded-lg p-4 bg-white shadow-sm max-w-full w-full sm:w-[90vw] md:w-[600px] lg:w-[700px] mx-auto">
            ...
            <div className='flex flex-row items-center justify-center gap-6'>
                <div className='flex flex-row gap-2 items-center'>
                    <div className='rounded-full w-4 h-4 bg-[#9012FF]'></div>
                    <span className="text-gray-500 text-lg">Invested</span>
                </div>
                <div className='flex flex-row gap-2 items-center'>
                    <div className='rounded-full w-4 h-4 bg-[#791F89]'></div>
                    <span className="text-gray-500 text-lg">Current</span>
                </div>
                <div className='flex flex-row gap-2 items-center'>
                    <div className='rounded-full w-4 h-4 bg-[#17B26A]'></div> {/* Green for Gain */}
                    <div className='rounded-full w-4 h-4 bg-[#F04438]'></div> {/* Red for Loss */}
                    <span className="text-gray-500 text-lg">Gain/Loss</span>
                </div>
            </div>
