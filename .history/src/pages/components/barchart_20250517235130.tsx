        ...
        <div className="flex flex-col gap-5 border border-gray-200 rounded-lg p-4 bg-white shadow-sm max-w-full w-full sm:w-[90vw] md:w-[600px] lg:w-[700px] mx-auto">
            ...
            <div className='flex flex-row items-center justify-center gap-3'>
                <div className='flex flex-row gap-1 items-center'>
                    <div className='rounded-full w-2 h-2 bg-[#9012FF]'></div>
                    <span className="text-gray-500 text-sm">Invested </span>
                </div>
                <div className='flex flex-row gap-1 items-center'>
                    <div className='rounded-full w-2 h-2 bg-[#791F89]'></div>
                    <span className="text-gray-500 text-sm">Current</span>
                </div>
                <div className='flex flex-row gap-1 items-center'>
                    <div className='rounded-full w-2 h-2 bg-[#17B26A]'></div> {/* Green for Gain */}
                    <div className='rounded-full w-2 h-2 bg-[#F04438]'></div>
                    <span className="text-gray-500 text-sm">Gain/Loss</span>
                </div>
            </div>
