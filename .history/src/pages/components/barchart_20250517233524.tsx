        ...
        <div className="flex flex-col gap-4 border border-gray-200 rounded-lg p-4 bg-white shadow-sm max-w-full w-full sm:w-[90vw] md:w-[600px] lg:w-[700px] mx-auto">
            ...
            <ResponsiveContainer width="100%" height={300}>
                ...
                >
                    ...
                    <Bar dataKey="invested" name="Invested" fill="#9012FF" barSize={40} />
                    <Bar dataKey="current" name="Current" fill="#17B26A" barSize={40} />
                    <Bar dataKey="gainLoss" name="Gain/Loss" barSize={40}>
