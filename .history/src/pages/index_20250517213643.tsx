...
export default function StockDashboard() {
  ...
  const currentValue = stocks.length === 0
    ? 0
    : Object.keys(PURCHASE_PRICE_MAP).reduce((total, symbol) => {
      const stock = stocks.find(s => s.symbol === symbol);
      const cmp = stock ? stock.cmp : 0;
      const quantity = QUANTITY_MAP[symbol] || 0;
  ...
  console.log('Total invested value:', investedValue);
