...
export default function Home() {
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col">
      {/* Header */}
      <header className="sticky top-0 z-10 flex justify-between px-4 md:px-6 py-3 md:py-4 bg-black border-b border-gray-200 shadow-sm items-center">
          ...
          <ResponsiveContainer width="90%" height={300}>
            ...
            >
              ...
              <Tooltip
                ...
                cursor={false} isAnimationActive={true}
              />
