    ...
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <div className="flex-1 px-4 py-6 overflow-auto flex flex-col gap-4 md:px-6">
        ...
        <div className='flex flex-row w-full  items-center '>
          <div className='flex flex-col w-1/2 gap-4 order border-gray-200 rounded-lg p-4'>
          ...
          <div className='flex flex-col w-1/2 gap-4 border border-gray-200 rounded-lg p-4'>
