      ...
      <div className="flex-1 px-4 py-6">
        <div className="flex flex-wrap gap-4 justify-between">
          {[
            ...
            <button
              key={index}
              className="flex flex-1 min-w-[240px] p-4 flex-col gap-2 border border-gray-200 rounded-lg bg-white transition-all duration-300 hover:shadow-md hover:border-gray-300"
            >
