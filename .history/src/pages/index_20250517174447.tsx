    ...
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-10 flex justify-between px-4 md:px-6 py-3 md:py-4 bg-white border-b border-gray-200 shadow-sm items-center">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-3 cursor-pointer rounded-md px-2 py-1 hover:bg-[#F8F3FF] transition-colors">
      ...
      <div className="flex-1 px-4 py-6 overflow-auto flex flex-col gap-6 md:px-6">
        ...
        <PieChartComponent />
        {/* React table */}
        <div className="overflow-x-auto rounded-lg bg-[#F7F8FB] text-[#667085] p-4 shadow">
          <table
            {...getTableProps()}
