...
const pieChartData = [
  { name: "Tata Motors", visitors: 100000, percentage: 10, fill: "#FF6384" },
  { name: "Reliance", visitors: 150000, percentage: 15, fill: "#36A2EB" },
  { name: "Infosys", visitors: 200000, percentage: 20, fill: "#FFCE56" },
  { name: "HDFC", visitors: 80000, percentage: 8, fill: "#4BC0C0" },
  { name: "ITC", visitors: 120000, percentage: 12, fill: "#9966FF" },
  { name: "Airtel", visitors: 70000, percentage: 7, fill: "#FF9F40" },
  { name: "Maruti", visitors: 130000, percentage: 13, fill: "#FFCD56" },
  { name: "ICICI", visitors: 60000, percentage: 6, fill: "#4D5360" },
  { name: "Asian Paints", visitors: 90000, percentage: 9, fill: "#C9CBCF" },
  { name: "SBI", visitors: 90000, percentage: 9, fill: "#B2FF66" },
];


// Calculate total invested amount
const totalInvested = pieChartData.reduce((sum, stock) => sum + stock.visitors, 0);
      ...
      >
        ...
        <div className="flex flex-col items-end">
          <p className="text-[0.938rem] font-semibold text-[#1D2939]">
            ₹{(visitors ?? 0).toLocaleString("en-IN")}
          </p>
